        ...
        <script>
            $(document).ready(function () {
                ...
                var table1 = $('#example1').DataTable({
                     ...
                     "scrollX": true,
                     "ajax": {
                        "url" : "ajax_table/ajax_table_cdr_details_llamada.php",
                        "type": 'POST',
                ...
                var chart_tari1 = c3.generate({
                    data: {
                        ...
                        <?php
                            ...
                            $pasado = date("Y-m-d H:i:s",strtotime($actual."- 24 hour"));
                            
                            //total
                            $consultTari = mysqli_query($link,"SELECT * FROM cdr 
                                                        WHERE LENGTH(cdr.src) > LENGTH(cdr.dst)
                                                        AND LENGTH(cdr.src) >= 6
                                                        AND cdr.calldate BETWEEN '$pasado' AND '$actual'");
                            $totalTari = mysqli_num_rows($consultTari);
                            
                            //
                            echo '["Llamadas Entrantes", '.$totalTari.' ],';
                ...
                var chart_tari2 = c3.generate({
                    data: {
                        ...
                        <?php
                            //optener rango de fechas por dia
                            $actual = date("Y-m-d H:i:s");
                            $pasado = date("Y-m-d H:i:s",strtotime($actual."- 48 hour"));
                ...
                var chart_tari3 = c3.generate({
                    data: {
                        ...
                        <?php
                            //optener rango de fechas por dia
                            $actual = date("Y-m-d H:i:s");
                            $pasado = date("Y-m-d H:i:s",strtotime($actual."- 72 hour"));                            
                ...
                var chart_tari1 = c3.generate({
                    data: {
                        ...
                        <?php
                            ...
                            $consultTari = mysqli_query($link,"SELECT * FROM cdr 
                                                        WHERE LENGTH(cdr.src) <= LENGTH(cdr.dst)
                                                        AND LENGTH(cdr.dst) >= 6
                                                        AND cdr.calldate BETWEEN '$pasado' AND '$actual'");
                            $totalTari = mysqli_num_rows($consultTari);
                            
                            //
                            echo '["Llamadas Salientes", '.$totalTari.' ],';
